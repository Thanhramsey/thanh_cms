        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item ">
                <a href="admin/images" class="nav-link">
                    ...
                    <span class="sidebar-text">Quàn lý hình ảnh</span>
                </a>
            </li>
            <li class="nav-item ">
                <a href="admin/videos" class="nav-link">
                    ...
                    <span class="sidebar-text">Quàn lý videos</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="admin/categorys" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item">
                <a href="admin/users" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M10 2a4 4 0 100 8 4 4 0 000-8zM2 16a6 6 0 1112 0H2z"
                                    clip-rule="evenodd" />
                            </svg>
                        </span>
            ...
            <li class="nav-item">
                <a href="admin/roles" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <span class="sidebar-text">Quản lý role</span>
                    </span>
                </a>
            </li>
            <li class="nav-item">
                <a href="admin/menus" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <span class="sidebar-text">Quản lý menu</span>
                    </span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="admin/banners" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <span class="sidebar-text">Quản lý Banner</span>
                    </span>
                </a>
            </li>
            <li class="nav-item">
                <a href="admin/configs" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <span class="sidebar-text">Quản lý cấu hình</span>
                    </span>
                </a>
            </li>
            <li class="nav-item">
                <a href="admin/contacts" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <li class="nav-item">
                <a href="admin/links" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <span class="sidebar-text">Quản lý liên kết</span>
                    </span>
                </a>
            </li>
            <li class="nav-item">
                <a href="admin/documents" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <span class="sidebar-text">Quản lý văn bản</span>
                    </span>
                </a>
            </li>
            <li class="nav-item">
